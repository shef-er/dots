...
" ,v
" open settings
  nnoremap <leader>v <esc>:e ~/.config/nvim/settings.vim<cr>

" ,vs
" open shortcuts
  nnoremap <leader>vs <esc>:e ~/.config/nvim/shortcuts.vim<cr>

" ,vp
" open plugs
  nnoremap <leader>vp <esc>:e ~/.config/nvim/plugs.vim<cr>
...
" open a terminal in current dir
  nnoremap <F4> :silent !gnome-terminal --tab &<CR>
